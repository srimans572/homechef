    ...
    if (vendorID) {
      const document_2 = onSnapshot(doc(db, "users", vendorID), (doc) => {
        try {
          ...
          setOpenDays(doc.data().availability)
        ...
        <div style={{ display: "flex", flexDirection: "row" }}>
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              >
                {openDays.map((item)=>(
                <p style={{padding:"10px 10px", background:"whitesmoke", borderRadius:"10px", border:"1px solid gainsboro"}}>{item}</p>
              ))}
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "flex" }}>
            ...
            >
              ...
              >
                ...
                >
                  <p style={{ margin: "0px" }}>
                    {openHoursStart && convertTo12Hour(openHoursStart)}
                  </p>
                </div>
                <p>to</p>
                <div
                ...
                >
                  <p style={{ margin: "0px" }}>
                    {openHoursEnd && convertTo12Hour(openHoursEnd)}
                  </p>
                </div>
              </div>
            </div>
